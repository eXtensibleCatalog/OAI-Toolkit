...
java -Xmx1024m -jar lib/OAIToolkit-0.5alpha.jar -load -convert -source marc -destination marc_dest -destination_xml xml -error error -error_xml error_xml -log log -log_detail -marc_schema schema/MARC21slim_rochester.xsd -marc_encoding UTF-8 -char_conversion MARC8 -split_size 10000 -storage_type Lucene -lucene_index lucene_index
